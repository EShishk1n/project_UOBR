...
from dvizhenie.services.calculate_all_ratings_and_put_into_DB import calculate_ratings_for_positions_and_put_into_DB, \
    get_rigs_for_calculation_rating, calculate_all_ratings_and_put_into_DB, get_free_pads
