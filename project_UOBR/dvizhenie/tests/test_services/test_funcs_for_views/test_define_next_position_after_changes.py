...
class DefineNextPositionAfterChangesTestCase(TestCase):
    def setUp(self):
    ...
    def test_define_next_position_after_changes(self):

        define_next_position_after_changes()

        self.assertEquals(NextPosition.objects.get(current_position=self.rig_position_2).next_position, self.pad_5)
        self.assertEquals(NextPosition.objects.get(current_position=self.rig_position_3).next_position, self.pad_10)
